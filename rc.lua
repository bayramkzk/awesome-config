...
awful.screen.connect_for_each_screen(function(s)
	...
	-- Create the wibox
	local positions = { "left", "right" }
	s.mywibox = awful.wibar({ position = positions[s.index], screen = s, width = 24 })
...
awful.spawn.with_shell("~/.config/awesome/scripts/mouseconfig.sh")
awful.spawn.with_shell("~/.config/awesome/scripts/autostart.sh")
awful.spawn.with_shell("~/.config/awesome/scripts/autotheme.sh")
